...
import 'package:projek_wa/core/providers/theme_provider.dart';
import 'package:projek_wa/core/routes/app_router.dart';
import 'package:projek_wa/features/auth/presentation/providers/auth_provider.dart';
import 'package:projek_wa/features/cart/presentation/providers/cart_provider.dart';
import 'package:projek_wa/features/dashboard/data/models/product_model.dart';
import 'package:projek_wa/features/dashboard/presentation/providers/product_provider.dart';
import 'package:projek_wa/features/order/presentation/providers/order_provider.dart';
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  final List<_CategoryItem> _categories = const [
    ...
    _CategoryItem(label: 'Robusta', icon: Icons.coffee),
    _CategoryItem(label: 'Arabica', icon: Icons.coffee),
    _CategoryItem(label: 'Tools', icon: Icons.coffee_maker),
  ];
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Color(0xFFf7ab1e), Color(0xFFf5cf8b)],
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Nikmati cita rasa kopi premium\ndari berbagai daerah Indonesia',
                  style: TextStyle(
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          CircleAvatar(
            radius: 30,
            backgroundColor: const Color(0xFFf7ab1e),
            child: Text(
